...
import { Mail, Lock, Eye, EyeOff, Phone, CheckCircle, Shield, Zap, ArrowRight } from 'lucide-react';
...
function Login() {
    ...
    const features = [
        {
            ...
            description: "Launch intelligent voice campaigns that convert",
            color: "text-blue-600",
            bgColor: "bg-blue-50"
        },
        {
    ...
    const handleSubmit = (e) => {
        ...
        // Optional: perform login logic/validation here
            ...
            <div className="flex-1 flex items-center justify-center px-6 py-12">
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-600">Sign in to access your AI voice campaign dashboard</p>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <button
                            ...
                            className="w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-semibold hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center"
                        >
                            Sign In
                ...
                <div className="relative flex flex-col justify-center px-12 py-12 text-white">
                    ...
                    <div className="mb-12">
                        ...
                        <p className="text-xl text-slate-300 leading-relaxed">
                            Join thousands of companies using our AI voice campaign platform to achieve unprecedented growth and customer engagement.
                        </p>
                    </div>
                    ...
                    <div className="mt-12 p-6 bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10">
                        <p className="text-slate-300 italic mb-4">
                            "This platform revolutionized our outreach campaigns. The AI voices are incredibly natural and our conversion rates increased by 300%."
                        </p>
                        <div className="flex items-center">
